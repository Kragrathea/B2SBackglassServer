...
Public Class B2SSettings
    ...
    Public Shared Property IsLampsStateLogOn() As Boolean = False
    Public Shared Property IsSolenoidsStateLogOn() As Boolean = False
    Public Shared Property IsGIStringsStateLogOn() As Boolean = False
    ...
    Public Shared Property AllOff() As Boolean = False
    Public Shared Property LampsOff() As Boolean = False
    Public Shared Property SolenoidsOff() As Boolean = False
